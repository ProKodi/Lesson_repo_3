...
W0=tf([1.7],[1 4.5 2.1]); %устойчивое инерционное звено 
subplot(121); step(W0,15); %переходной процесс 
subplot(122); impulse(W0,15); %весовая функция

%частотные характеристики 
num=[1.7]; den=[1 4.5 2.1]; 
